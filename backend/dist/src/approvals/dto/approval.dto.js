...
exports.RejectDto = exports.ApproveDto = exports.ApprovalQueryDto = void 0;
...
], ApprovalQueryDto.prototype, "examType", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
...
], ApprovalQueryDto.prototype, "page", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Transform)(({ value }) => parseInt(value, 10)),
    (0, class_validator_1.IsInt)(),
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], ApproveDto.prototype, "notes", void 0);
class RejectDto {
    reason;
}
