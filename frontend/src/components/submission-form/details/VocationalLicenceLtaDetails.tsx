...
export function VocationalLicenceLtaDetails({ submission }: VocationalLicenceLtaDetailsProps) {
  ...
  const getMemoData = () => {
    const memoReq = data.memoRequirements 
      ...
      {assessment && (
        <div className="bg-white border-2 border-slate-300 rounded-lg shadow-sm">
          ...
          <div className="p-6">
            ...
            {/* Bus Attendant Licence (conditional for AGE_64_BELOW_LTA_ONLY when not fit for public service) */}
              ...
              <div className="pt-4 border-t border-blue-200">
                ...
                <div className="bg-blue-50 p-3 rounded border border-blue-200">
                  ...
                  <ul className="ml-6 mt-2 space-y-2 text-sm leading-relaxed text-gray-700 list-disc">
                    <li>The information provided in this form is true and correct to the best of my knowledge</li>
                    <li>I have conducted a thorough medical examination of the patient</li>
                  </ul>
                </div>
              </div>
            )}
