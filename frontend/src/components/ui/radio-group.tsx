...
function RadioGroupItem({
  ...
  return (
    <RadioGroupPrimitive.Item
      ...
      className={cn(
        `${borderClass} bg-white text-black ${focusClasses} aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 dark:bg-input/30 aspect-square size-4 shrink-0 rounded-full border shadow-xs transition-[color,box-shadow] outline-none disabled:cursor-not-allowed disabled:opacity-50`,
        className,
      )}
      {...props}
    >
